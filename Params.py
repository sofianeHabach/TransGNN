...
def ParseArgs():
	...
	parser.add_argument('--sample_size', default=20, type=int, 
                    help='number of attention samples (k)')
	parser.add_argument('--update_strategy', default='message_passing', type=str,
						help='sample update strategy: message_passing or random_walk')
	parser.add_argument('--update_frequency', default=3, type=int,
						help='update samples every N epochs')
